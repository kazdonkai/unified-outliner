...
- **1.0.0 に向けた Phase 5E の仕上げ**: Outline Tree でのブロックコピー（Copy block／Duplicate below／Paste block、Phase 5E-Copy）は実装済みで実機受入確認待ちである。続いてミラー機能（Phase 5M、参照・投影型のブロック表示）に着手し、両者の完成をもって 1.0.0 とする。
