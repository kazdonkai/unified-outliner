...
- **Block ID follow-ups**: adding a new id to a block that has none from the Partial Edit Pane, checking a new id for duplicates in the note, and optionally offering to update references in other notes.
